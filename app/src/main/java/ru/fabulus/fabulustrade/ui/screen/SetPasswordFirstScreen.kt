...
class SetPasswordFirstFragment : MvpAppCompatFragment() {
    ...
    private val viewModel by viewModels<SetPasswordFirstViewModel> { viewModelFactory }

    companion object {
        fun newInstance() = SetPasswordFirstFragment().apply {
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            setContent {
                SetPasswordFirstScreen(viewModel, router)
            }
        }
    }
}
...
@Composable
fun SetPasswordFirstScreen(viewModel: SetPasswordFirstViewModel, router: Router) {
    ...
    ProfileEditingDialogs(successMessage = successMessage,
        ...
        {
            viewModel.openPasswordSecondScreen()
...
@Composable
fun DefaultSetPasswordFirstScreenPreview() {
    ...
    val viewModel = SetPasswordFirstViewModel().apply {
        profile = fakeProfile
    }

    // Вызовем SetPasswordFirstScreen
    SetPasswordFirstScreen(viewModel, fakeRouter)
}